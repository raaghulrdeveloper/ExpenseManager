...
import com.raaghulr.expensemanager.helpers.CustomDatePickerDialog;
...
public class GenerateReport extends BaseActivity implements OnClickListener {
	...
	private abstract class Export extends AsyncTask<Void, Void, Void> {
		...
		protected void setFile() {
			File dir = new File(Environment.getExternalStorageDirectory()+"/Expensemanager");
	...
	private class ExportPDF extends Export {
		...
		// add metadata to the PDF which can be viewed in your Adobe Reader
	 	...
	 	private void addMetaData(Document document) {
	 		document.addTitle("Expenses Report using Expense Manager (Raaghul.R)");
	 		document.addSubject("PDF created using android app \"Expense Manager (Raaghul.R)\"");
	 		document.addKeywords("Android, PDF, Raaghul.R, Expense, manager, Expense Manager");
	 		document.addAuthor("Raaghul.R");
	 		document.addCreator("Raaghul.R");
	 	}
		...
		private void addEmptyLine(Paragraph paragraph, int number) {
	 	...
	 	public class HeaderAndFooter extends PdfPageEventHelper {
	 		...
	 		public HeaderAndFooter() {
	 			...
	 			Chunk chunk = new Chunk("Report Generated Using - Expense Manager (Raaghul.R)");
