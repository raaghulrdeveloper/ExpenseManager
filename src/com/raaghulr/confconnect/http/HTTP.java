package com.raaghulr.confconnect.http;
...
import com.raaghulr.expensemanager.utils.Utils;
...
public class HTTP {
	...
	private String execute(String url, HttpEntity postData, String requestMethod) throws IOException {
    	...
    	try {
    		...
    		connection.setRequestProperty("User-Agent", String.format("Expensemanager"+mContext.getString(R.string.version)+" Android(%s/%s)", Build.VERSION.RELEASE, Build.VERSION.INCREMENTAL));
