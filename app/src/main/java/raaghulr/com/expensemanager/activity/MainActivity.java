...
import raaghulr.com.expensemanager.adapter.DrawerListViewAdapter;
import raaghulr.com.expensemanager.adapter.HomeViewPagerAdapter;
import raaghulr.com.expensemanager.notification.FillExpenseNotificationScheduler;
import raaghulr.com.expensemanager.presenter.NavigationDrawerPresenter;
...
public class MainActivity extends FragmentActivity implements NavigationDrawerItemView, ActionBar.TabListener {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == R.id.help) {
      Intent intent = new Intent(this, raaghulr.com.expensemanager.activity.Help.class);
      startActivityForResult(intent, ADD_NEW_CAT);
      return true;
    }

    if (id == R.id.aboutus) {
      Intent intent = new Intent(this, raaghulr.com.expensemanager.activity.AboutUs.class);
      startActivityForResult(intent, ADD_NEW_CAT);
      return true;
    }

    if (id == R.id.exit) {
      Intent intent = new Intent(this, raaghulr.com.expensemanager.activity.Exit.class);
      startActivityForResult(intent, ADD_NEW_CAT);
      return true;
    }
